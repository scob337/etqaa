              ...
              <div className="bg-cyber-secondary rounded-2xl overflow-hidden border border-cyber-gray-dark hover:shadow-cyber-hover hover:-translate-y-2 transition-all duration-500 flex flex-col h-full">
                ...
                <div dir={isRTL ? "rtl" : "ltr"} className="p-7 flex-1 flex flex-col">
                  ...
                  <Link 
                    ...
                    className={`inline-flex items-center justify-between px-6 py-3 bg-cyber-gray-dark text-white rounded-cyber border border-cyber-accent/10 hover:bg-cyber-accent/20 hover:border-cyber-accent/40 hover:text-white transition-all duration-300 group/btn ${isRTL ? 'flex-row-reverse' : ''}`}
                  >
                    <span className="font-medium">{t('services.learnMore')}</span>
                    {isRTL ? 
                      <FaArrowLeft className={`mr-3 group-hover/btn:-translate-x-1 transition-transform`} /> : 
